...
let Gender = prompt(document.getElementById("gender"))
.value// check the gender the user has checked
let day = prompt(document.getElementById("day"))
.value//check the users input

const day = ( ( (CC/4) -2*CC-1) + ((5*YY/4) ) + ((26*(MM+1)/10)) + DD ) mod 7
...
console.log(dayBorn)
const daysofTheWeek = parseInt(["Sun","Mon","Tue","Wed","Tue","Wed","Thurs","Fri","Sat"])
console.log(daysofTheWeek[dayborn])
let dayofTheweek = parseInt(daysofTheWeek[dayBorn])
